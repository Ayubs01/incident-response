      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="card rounded-4 my-4 shadow mb-5 py-5 mx-auto col-md-3 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="row mt-1 mb-4">
            ...
            height: 105px; 
            border: 1px solid #741a62; 
            border-radius: 50%; 
            margin: auto; background-color: #741a62;" class="col-md-12 card-icon rounded-circle d-flex align-items-center justify-content-center">
							<a href='#'><i class="bi bi-exclamation-triangle-fill fa-3x text-white"></i></a>
						</div>
